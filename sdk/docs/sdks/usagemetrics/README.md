...
import { dataUsageMetricsGetUsage } from "@avalanche-sdk/sdk/funcs/dataUsageMetricsGetUsage.js";
...
async function run() {
  const res = await dataUsageMetricsGetUsage(avalanche.data, {
    startTimestamp: 1739507200,
    endTimestamp: 1739664000,
    timeInterval: "daily",
    groupBy: "requestPath",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataUsageMetricsGetLogs } from "@avalanche-sdk/sdk/funcs/dataUsageMetricsGetLogs.js";
...
async function run() {
  const res = await dataUsageMetricsGetLogs(avalanche.data, {
    startTimestamp: 1739507200,
    endTimestamp: 1739664000,
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataUsageMetricsGetSubnetRpcUsage } from "@avalanche-sdk/sdk/funcs/dataUsageMetricsGetSubnetRpcUsage.js";
...
async function run() {
  const res = await dataUsageMetricsGetSubnetRpcUsage(avalanche.data, {
    timeInterval: "daily",
    startTimestamp: 1739507200,
    endTimestamp: 1739664000,
    groupBy: "rpcMethod",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataUsageMetricsGetRpcUsageMetrics } from "@avalanche-sdk/sdk/funcs/dataUsageMetricsGetRpcUsageMetrics.js";
...
async function run() {
  const res = await dataUsageMetricsGetRpcUsageMetrics(avalanche.data, {
    timeInterval: "daily",
    startTimestamp: 1739507200,
    endTimestamp: 1739664000,
    groupBy: "rpcMethod",
