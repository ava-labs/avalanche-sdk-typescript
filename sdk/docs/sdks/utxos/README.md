...
import { dataPrimaryNetworkUtxosListByAddresses } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkUtxosListByAddresses.js";
...
async function run() {
  const res = await dataPrimaryNetworkUtxosListByAddresses(avalanche.data, {
    addresses: "avax1h2ccj9f5ay5acl6tyn9mwmw32p8wref8vl8ctg",
    blockchainId: "p-chain",
    network: "mainnet",
    sortOrder: "asc",
