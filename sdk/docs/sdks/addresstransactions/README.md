...
import { dataEvmAddressTransactionsList } from "@avalanche-sdk/sdk/funcs/dataEvmAddressTransactionsList.js";
...
async function run() {
  const res = await dataEvmAddressTransactionsList(avalanche.data, {
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressTransactionsListNative } from "@avalanche-sdk/sdk/funcs/dataEvmAddressTransactionsListNative.js";
...
async function run() {
  const res = await dataEvmAddressTransactionsListNative(avalanche.data, {
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressTransactionsListErc20 } from "@avalanche-sdk/sdk/funcs/dataEvmAddressTransactionsListErc20.js";
...
async function run() {
  const res = await dataEvmAddressTransactionsListErc20(avalanche.data, {
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressTransactionsListErc721 } from "@avalanche-sdk/sdk/funcs/dataEvmAddressTransactionsListErc721.js";
...
async function run() {
  const res = await dataEvmAddressTransactionsListErc721(avalanche.data, {
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressTransactionsListErc1155 } from "@avalanche-sdk/sdk/funcs/dataEvmAddressTransactionsListErc1155.js";
...
async function run() {
  const res = await dataEvmAddressTransactionsListErc1155(avalanche.data, {
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressTransactionsListInternal } from "@avalanche-sdk/sdk/funcs/dataEvmAddressTransactionsListInternal.js";
...
async function run() {
  const res = await dataEvmAddressTransactionsListInternal(avalanche.data, {
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
