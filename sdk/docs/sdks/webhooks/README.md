...
import { webhooksHealthCheck } from "@avalanche-sdk/sdk/funcs/webhooksHealthCheck.js";
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { webhooksCreate } from "@avalanche-sdk/sdk/funcs/webhooksCreate.js";
...
async function run() {
  const res = await webhooksCreate(avalanche.webhooks, {
    eventType: "validator_activity",
    url: "https://expensive-designation.info",
    chainId: "<id>",
    metadata: {
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { webhooksList } from "@avalanche-sdk/sdk/funcs/webhooksList.js";
...
async function run() {
  const res = await webhooksList(avalanche.webhooks, {
    status: "active",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { webhooksGet } from "@avalanche-sdk/sdk/funcs/webhooksGet.js";
...
async function run() {
  const res = await webhooksGet(avalanche.webhooks, {
    id: "f33de69c-d13b-4691-908f-870d6e2e6b04",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { webhooksDeactivate } from "@avalanche-sdk/sdk/funcs/webhooksDeactivate.js";
...
async function run() {
  const res = await webhooksDeactivate(avalanche.webhooks, {
    id: "f33de69c-d13b-4691-908f-870d6e2e6b04",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { webhooksUpdate } from "@avalanche-sdk/sdk/funcs/webhooksUpdate.js";
...
async function run() {
  const res = await webhooksUpdate(avalanche.webhooks, {
    id: "f33de69c-d13b-4691-908f-870d6e2e6b04",
    updateWebhookRequest: {},
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { webhooksGenerateOrRotateSharedSecret } from "@avalanche-sdk/sdk/funcs/webhooksGenerateOrRotateSharedSecret.js";
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { webhooksGetSharedSecret } from "@avalanche-sdk/sdk/funcs/webhooksGetSharedSecret.js";
