...
import { dataEvmAddressContractsListDeployments } from "@avalanche-sdk/sdk/funcs/dataEvmAddressContractsListDeployments.js";
...
async function run() {
  const res = await dataEvmAddressContractsListDeployments(avalanche.data, {
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
  });
