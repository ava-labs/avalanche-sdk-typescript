...
import { dataEvmContractsGetDeploymentTransaction } from "@avalanche-sdk/sdk/funcs/dataEvmContractsGetDeploymentTransaction.js";
...
async function run() {
  const res = await dataEvmContractsGetDeploymentTransaction(avalanche.data, {
    chainId: "43114",
    address: "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E",
    currency: "usd",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmContractsGetMetadata } from "@avalanche-sdk/sdk/funcs/dataEvmContractsGetMetadata.js";
...
async function run() {
  const res = await dataEvmContractsGetMetadata(avalanche.data, {
    chainId: "43114",
    address: "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmContractsListTransfers } from "@avalanche-sdk/sdk/funcs/dataEvmContractsListTransfers.js";
...
async function run() {
  const res = await dataEvmContractsListTransfers(avalanche.data, {
    startBlock: 6479329,
    endBlock: 6479330,
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
