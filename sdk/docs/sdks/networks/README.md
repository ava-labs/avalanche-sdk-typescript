...
import { metricsNetworksGetStakingMetrics } from "@avalanche-sdk/sdk/funcs/metricsNetworksGetStakingMetrics.js";
...
async function run() {
  const res = await metricsNetworksGetStakingMetrics(avalanche.metrics, {
    metric: "validatorCount",
    startTimestamp: 1689541049,
    endTimestamp: 1689800249,
    network: "mainnet",
