...
import { dataPrimaryNetworkBalancesListByAddresses } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkBalancesListByAddresses.js";
...
async function run() {
  const res = await dataPrimaryNetworkBalancesListByAddresses(avalanche.data, {
    blockTimestamp: 1599696000,
    addresses: "avax1h2ccj9f5ay5acl6tyn9mwmw32p8wref8vl8ctg",
    blockchainId: "p-chain",
    network: "mainnet",
