...
import { dataPrimaryNetworkTransactionsGet } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkTransactionsGet.js";
...
async function run() {
  const res = await dataPrimaryNetworkTransactionsGet(avalanche.data, {
    blockchainId: "p-chain",
    network: "mainnet",
    txHash: "3P91K6nuDFvDodcRuJTsgdf9SvYe5pMiKk38HppsoeAiEztCP",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkTransactionsListLatest } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkTransactionsListLatest.js";
...
async function run() {
  const res = await dataPrimaryNetworkTransactionsListLatest(avalanche.data, {
    addresses: "avax1h2ccj9f5ay5acl6tyn9mwmw32p8wref8vl8ctg",
    txTypes: [
      "AddValidatorTx",
    ],
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkTransactionsListActiveStakingTransactions } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkTransactionsListActiveStakingTransactions.js";
...
async function run() {
  const res = await dataPrimaryNetworkTransactionsListActiveStakingTransactions(avalanche.data, {
    addresses: "avax1h2ccj9f5ay5acl6tyn9mwmw32p8wref8vl8ctg",
    txTypes: [
      "AddValidatorTx",
    ],
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkTransactionsListAssetTransactions } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkTransactionsListAssetTransactions.js";
...
async function run() {
  const res = await dataPrimaryNetworkTransactionsListAssetTransactions(avalanche.data, {
    txTypes: [
      "AddValidatorTx",
    ],
    startTimestamp: 1689541049,
