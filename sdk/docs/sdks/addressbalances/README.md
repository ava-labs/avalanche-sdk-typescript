...
import { dataEvmAddressBalancesGetNative } from "@avalanche-sdk/sdk/funcs/dataEvmAddressBalancesGetNative.js";
...
async function run() {
  const res = await dataEvmAddressBalancesGetNative(avalanche.data, {
    blockNumber: "6479329",
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
    currency: "usd",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressBalancesListErc20 } from "@avalanche-sdk/sdk/funcs/dataEvmAddressBalancesListErc20.js";
...
async function run() {
  const res = await dataEvmAddressBalancesListErc20(avalanche.data, {
    blockNumber: "6479329",
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
    contractAddresses: "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7, 0x49D5c2BdFfac6CE2BFdB6640F4F80f226bc10bAB",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressBalancesListErc721 } from "@avalanche-sdk/sdk/funcs/dataEvmAddressBalancesListErc721.js";
...
async function run() {
  const res = await dataEvmAddressBalancesListErc721(avalanche.data, {
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
    contractAddress: "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressBalancesListErc1155 } from "@avalanche-sdk/sdk/funcs/dataEvmAddressBalancesListErc1155.js";
...
async function run() {
  const res = await dataEvmAddressBalancesListErc1155(avalanche.data, {
    blockNumber: "6479329",
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
    contractAddress: "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataEvmAddressBalancesListCollectibles } from "@avalanche-sdk/sdk/funcs/dataEvmAddressBalancesListCollectibles.js";
...
async function run() {
  const res = await dataEvmAddressBalancesListCollectibles(avalanche.data, {
    chainId: "43114",
    address: "0x71C7656EC7ab88b098defB751B7401B5f6d8976F",
    contractAddress: "0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7",
  });
