...
import { metricsSubnetsGetValidators } from "@avalanche-sdk/sdk/funcs/metricsSubnetsGetValidators.js";
...
async function run() {
  const res = await metricsSubnetsGetValidators(avalanche.metrics, {
    startTimestamp: 1689541049,
    endTimestamp: 1689800249,
    subnetId: "11111111111111111111111111111111LpoYY",
    network: "mainnet",
