...
import { dataPrimaryNetworkGetAssetDetails } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkGetAssetDetails.js";
...
async function run() {
  const res = await dataPrimaryNetworkGetAssetDetails(avalanche.data, {
    blockchainId: "x-chain",
    network: "mainnet",
    assetId: "th5aLdWLi32yS9ED6uLGoMMubqHjzMsXhKWwzP6yZTYQKYzof",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkGetChainIdsForAddresses } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkGetChainIdsForAddresses.js";
...
async function run() {
  const res = await dataPrimaryNetworkGetChainIdsForAddresses(avalanche.data, {
    addresses: "avax1h2ccj9f5ay5acl6tyn9mwmw32p8wref8vl8ctg",
    network: "mainnet",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkGetNetworkDetails } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkGetNetworkDetails.js";
...
async function run() {
  const res = await dataPrimaryNetworkGetNetworkDetails(avalanche.data, {
    network: "mainnet",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkListBlockchains } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkListBlockchains.js";
...
async function run() {
  const res = await dataPrimaryNetworkListBlockchains(avalanche.data, {
    network: "mainnet",
    sortOrder: "asc",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkGetBlockchainById } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkGetBlockchainById.js";
...
async function run() {
  const res = await dataPrimaryNetworkGetBlockchainById(avalanche.data, {
    blockchainId: "2q9e4r6Mu3U68nU1fYjgbR6JvwrRx36CohpAX5UQxse55x1Q5",
    network: "mainnet",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkListSubnets } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkListSubnets.js";
...
async function run() {
  const res = await dataPrimaryNetworkListSubnets(avalanche.data, {
    network: "mainnet",
    sortOrder: "asc",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkGetSubnetById } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkGetSubnetById.js";
...
async function run() {
  const res = await dataPrimaryNetworkGetSubnetById(avalanche.data, {
    network: "mainnet",
    subnetId: "11111111111111111111111111111111LpoYY",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkListValidators } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkListValidators.js";
...
async function run() {
  const res = await dataPrimaryNetworkListValidators(avalanche.data, {
    network: "mainnet",
    nodeIds: "NodeID-111111111111111111116DBWJs,NodeID-222222222222222222227DBWJs",
    sortOrder: "asc",
    validationStatus: "completed",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkGetValidatorDetails } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkGetValidatorDetails.js";
...
async function run() {
  const res = await dataPrimaryNetworkGetValidatorDetails(avalanche.data, {
    network: "mainnet",
    nodeId: "NodeID-111111111111111111116DBWJs",
    validationStatus: "completed",
    sortOrder: "asc",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkListDelegators } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkListDelegators.js";
...
async function run() {
  const res = await dataPrimaryNetworkListDelegators(avalanche.data, {
    rewardAddresses: "P-avax1679zrp3z9mf7z4an42ddq47qzj36zv6ga20vwl,P-avax1s7kd0kfndlz6mh3l0etrrcmkg5y366k8e0s6cc",
    network: "mainnet",
    sortOrder: "asc",
    delegationStatus: "completed",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/sdk/core.js";
import { dataPrimaryNetworkListL1Validators } from "@avalanche-sdk/sdk/funcs/dataPrimaryNetworkListL1Validators.js";
...
async function run() {
  const res = await dataPrimaryNetworkListL1Validators(avalanche.data, {
    l1ValidationId: "BsSpTd1SDvdhaoYAuKJvRj1WnoRyu8mAuMZeuz9g7brGj6KhX",
    network: "mainnet",
    nodeId: "NodeID-111111111111111111116DBWJs",
    subnetId: "11111111111111111111111111111111LpoYY",
