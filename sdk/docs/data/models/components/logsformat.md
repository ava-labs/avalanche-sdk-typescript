...
```typescript
import { LogsFormat } from "@avalanche-sdk/sdk/data/models/components";

let value: LogsFormat = {
  orgId: "<id>",
  logId: "<id>",
  eventTimestamp: 5269.07,
  apiKeyId: "<id>",
  apiKeyAlias: "<value>",
  hostRegion: "<value>",
  requestType: "data",
  requestPath: "<value>",
  apiCreditsConsumed: 5.45,
  requestDurationMsecs: 4254.02,
  responseCode: 635.53,
  metadata: {
    ipAddress: "238.55.219.205",
    host: "curly-nightlife.com",
    userAgent: "<value>",
  },
};
```
