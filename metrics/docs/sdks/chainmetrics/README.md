...
async function run() {
  const result = await avalanche.metrics.chain.metrics.getEvmChainMetrics({
...
import { metricsChainMetricsGetEvmChainMetrics } from "@avalanche-sdk/metrics/funcs/metricsChainMetricsGetEvmChainMetrics.js";
...
async function run() {
  const res = await metricsChainMetricsGetEvmChainMetrics(avalanche, {
    metric: "activeAddresses",
    startTimestamp: 1689541049,
    endTimestamp: 1689800249,
    timeInterval: "day",
...
async function run() {
  const result = await avalanche.metrics.chain.metrics.getTeleporterMetricsByChain({
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/metrics/core.js";
import { metricsChainMetricsGetTeleporterMetricsByChain } from "@avalanche-sdk/metrics/funcs/metricsChainMetricsGetTeleporterMetricsByChain.js";
...
async function run() {
  const res = await metricsChainMetricsGetTeleporterMetricsByChain(avalanche, {
    metric: "teleporterSourceTxnCount",
    chainId: "43114",
  });
...
async function run() {
  const result = await avalanche.metrics.chain.metrics.getEvmChainRollingWindowMetrics({
    metric: "txCount",
    chainId: "43114",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/metrics/core.js";
import { metricsChainMetricsGetEvmChainRollingWindowMetrics } from "@avalanche-sdk/metrics/funcs/metricsChainMetricsGetEvmChainRollingWindowMetrics.js";
...
async function run() {
  const res = await metricsChainMetricsGetEvmChainRollingWindowMetrics(avalanche, {
    metric: "txCount",
    chainId: "43114",
  });
...
async function run() {
  const result = await avalanche.metrics.chain.metrics.getStakingMetrics({
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/metrics/core.js";
import { metricsChainMetricsGetStakingMetrics } from "@avalanche-sdk/metrics/funcs/metricsChainMetricsGetStakingMetrics.js";
...
async function run() {
  const res = await metricsChainMetricsGetStakingMetrics(avalanche, {
    metric: "validatorCount",
    startTimestamp: 1689541049,
    endTimestamp: 1689800249,
    network: "mainnet",
