...
async function run() {
  const result = await avalanche.data.evm.blocks.listLatestBlocksAllChains({
    network: "mainnet",
  });
...
import { dataEvmBlocksListLatestBlocksAllChains } from "@avalanche-sdk/data/funcs/dataEvmBlocksListLatestBlocksAllChains.js";
...
async function run() {
  const res = await dataEvmBlocksListLatestBlocksAllChains(avalanche, {
    network: "mainnet",
  });
...
async function run() {
  const result = await avalanche.data.evm.blocks.getLatestBlocks({
    chainId: "43114",
  });
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/data/core.js";
import { dataEvmBlocksGetLatestBlocks } from "@avalanche-sdk/data/funcs/dataEvmBlocksGetLatestBlocks.js";
...
async function run() {
  const res = await dataEvmBlocksGetLatestBlocks(avalanche, {
    chainId: "43114",
  });
...
async function run() {
  const result = await avalanche.data.evm.blocks.getBlock({
    chainId: "43114",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/data/core.js";
import { dataEvmBlocksGetBlock } from "@avalanche-sdk/data/funcs/dataEvmBlocksGetBlock.js";
...
async function run() {
  const res = await dataEvmBlocksGetBlock(avalanche, {
    chainId: "43114",
    blockId: "0x17533aeb5193378b9ff441d61728e7a2ebaf10f61fd5310759451627dfca2e7c",
  });
