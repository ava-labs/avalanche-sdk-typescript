...
* [getAggregatedSignatures](#getaggregatedsignatures) - Get Aggregated Signatures
...
async function run() {
  const result = await avalanche.data.signatureAggregator.aggregateSignatures({
    network: "mainnet",
...
import { dataSignatureAggregatorAggregateSignatures } from "@avalanche-sdk/data/funcs/dataSignatureAggregatorAggregateSignatures.js";
...
async function run() {
  const res = await dataSignatureAggregatorAggregateSignatures(avalanche, {
    network: "mainnet",
    signatureAggregatorRequest: {
      message: "",
      justification: "0001abcdabcfff",
...
async function run() {
  const result = await avalanche.data.signatureAggregator.getAggregatedSignatures({
    network: "mainnet",
...
```typescript
import { AvalancheCore } from "@avalanche-sdk/data/core.js";
import { dataSignatureAggregatorGetAggregatedSignatures } from "@avalanche-sdk/data/funcs/dataSignatureAggregatorGetAggregatedSignatures.js";
...
async function run() {
  const res = await dataSignatureAggregatorGetAggregatedSignatures(avalanche, {
    network: "mainnet",
    txHash: "3P91K6nuDFvDodcRuJTsgdf9SvYe5pMiKk38HppsoeAiEztCP",
  });
