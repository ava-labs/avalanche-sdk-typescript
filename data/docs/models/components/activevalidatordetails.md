...
let value: ActiveValidatorDetails = {
  ...
  subnetId: "<id>",
  amountStaked: "<value>",
  startTimestamp: 1629.54,
  endTimestamp: 6387.62,
  stakePercentage: 4903.05,
  delegatorCount: 9894.1,
  uptimePerformance: 653.04,
  potentialRewards: {
  ...
  validatorHealth: {
    reachabilityPercent: 7832.35,
    benchedPChainRequestsPercent: 2883.98,
    benchedXChainRequestsPercent: 2414.18,
    benchedCChainRequestsPercent: 6625.05,
  },
};
```
