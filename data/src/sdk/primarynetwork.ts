...
export class PrimaryNetwork extends ClientSDK {
  private _transactions?: PrimaryNetworkTransactions;
  get transactions(): PrimaryNetworkTransactions {
    return (this._transactions ??= new PrimaryNetworkTransactions(
      this._options,
    ));
  }
  ...
  private _balances?: PrimaryNetworkBalances;
  get balances(): PrimaryNetworkBalances {
    return (this._balances ??= new PrimaryNetworkBalances(this._options));
  }

  private _blocks?: PrimaryNetworkBlocks;
  get blocks(): PrimaryNetworkBlocks {
    return (this._blocks ??= new PrimaryNetworkBlocks(this._options));
  }
