 ...
 */
export const XChainNonLinearTransactionChainFormat = {
 ...
 * Represents chain format this transaction is included in.
 */
export type XChainNonLinearTransactionChainFormat = ClosedEnum<
  typeof XChainNonLinearTransactionChainFormat
>;
...
export type XChainNonLinearTransaction = {
   ...
   * Represents chain format this transaction is included in.
   */
  chainFormat: XChainNonLinearTransactionChainFormat;
  /**
...
/** @internal */
export const XChainNonLinearTransactionChainFormat$inboundSchema:
...
> = z.object({
  txHash: z.string(),
  chainFormat: XChainNonLinearTransactionChainFormat$inboundSchema,
  timestamp: z.number(),
...
> = z.object({
  txHash: z.string(),
  chainFormat: XChainNonLinearTransactionChainFormat$outboundSchema,
  timestamp: z.number(),
