...
type GetRPCUsageMetricsRequest struct {
...
func (o *GetRPCUsageMetricsRequest) GetTimeInterval() *components.SubnetRPCTimeIntervalGranularity {
	if o == nil {
		return nil
	}
...
func (o *GetRPCUsageMetricsRequest) GetStartTimestamp() *int64 {
	if o == nil {
		return nil
	}
...
func (o *GetRPCUsageMetricsRequest) GetEndTimestamp() *int64 {
	if o == nil {
		return nil
	}
...
func (o *GetRPCUsageMetricsRequest) GetGroupBy() *components.RPCUsageMetricsGroupByEnum {
	if o == nil {
		return nil
	}
	return o.GroupBy
...
func (o *GetRPCUsageMetricsRequest) GetChainID() *string {
	if o == nil {
		return nil
	}
	return o.ChainID
...
func (o *GetRPCUsageMetricsRequest) GetResponseCode() *string {
	if o == nil {
		return nil
	}
...
func (o *GetRPCUsageMetricsRequest) GetRPCMethod() *string {
	if o == nil {
		return nil
	}
	return o.RPCMethod
...
func (o *GetRPCUsageMetricsRequest) GetRlBypassAPIToken() *string {
	if o == nil {
		return nil
	}
...
type GetRPCUsageMetricsResponse struct {
	HTTPMeta components.HTTPMetadata `json:"-"`
	// Successful response
	SubnetRPCUsageMetricsResponseDTO *components.SubnetRPCUsageMetricsResponseDTO
}

func (o *GetRPCUsageMetricsResponse) GetHTTPMeta() components.HTTPMetadata {
	if o == nil {
...
func (o *GetRPCUsageMetricsResponse) GetSubnetRPCUsageMetricsResponseDTO() *components.SubnetRPCUsageMetricsResponseDTO {
	if o == nil {
		return nil
	}
