 ...
 */
export function dataOperationsPostTransactionExportJob(
  client: AvalancheCore,
  request: operations.PostTransactionExportJobRequest,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.PostTransactionExportJobRequest$outboundSchema.parse(value),
