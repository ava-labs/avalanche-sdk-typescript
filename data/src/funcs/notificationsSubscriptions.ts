...
export function notificationsSubscriptions(
  ...
  Result<
    components.SubscriptionsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.SubscriptionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/notifications/subscriptions")();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, components.SubscriptionsResponse$inboundSchema),
