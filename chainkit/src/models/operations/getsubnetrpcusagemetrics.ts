...
/** @internal */
export const GetSubnetRpcUsageMetricsRequest$inboundSchema: z.ZodType<
...
/** @internal */
export const GetSubnetRpcUsageMetricsRequest$outboundSchema: z.ZodType<
  GetSubnetRpcUsageMetricsRequest$Outbound,
  z.ZodTypeDef,
  GetSubnetRpcUsageMetricsRequest
> = z.object({
...
export function getSubnetRpcUsageMetricsRequestToJSON(
  ...
  return JSON.stringify(
    GetSubnetRpcUsageMetricsRequest$outboundSchema.parse(
      getSubnetRpcUsageMetricsRequest,
    ),
  );
}
...
export function getSubnetRpcUsageMetricsRequestFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => GetSubnetRpcUsageMetricsRequest$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'GetSubnetRpcUsageMetricsRequest' from JSON`,
  );
}
