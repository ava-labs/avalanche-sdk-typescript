...
export const Erc721TokenErcType = {
  Erc721: "ERC-721",
} as const;
export type Erc721TokenErcType = ClosedEnum<typeof Erc721TokenErcType>;
...
> = z.object({
  ...
  name: z.string(),
  symbol: z.string(),
  ercType: Erc721TokenErcType$inboundSchema,
  tokenId: z.string(),
  tokenUri: z.string(),
...
> = z.object({
  ...
  name: z.string(),
  symbol: z.string(),
  ercType: Erc721TokenErcType$outboundSchema,
  tokenId: z.string(),
  tokenUri: z.string(),
...
export function erc721TokenFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => Erc721Token$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Erc721Token' from JSON`,
  );
}
