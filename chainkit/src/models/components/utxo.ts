...
/** @internal */
export const Utxo$inboundSchema: z.ZodType<Utxo, z.ZodTypeDef, unknown> = z
  .object({
...
/** @internal */
export const Utxo$outboundSchema: z.ZodType<Utxo$Outbound, z.ZodTypeDef, Utxo> =
  z.object({
    addresses: z.array(z.string()),
...
export function utxoFromJSON(
  ...
  return safeParse(
    jsonString,
    (x) => Utxo$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'Utxo' from JSON`,
  );
}
