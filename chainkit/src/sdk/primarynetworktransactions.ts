...
export class PrimaryNetworkTransactions extends ClientSDK {
  ...
  ): Promise<operations.GetTxByHashResponse> {
    return unwrapAsync(dataPrimaryNetworkTransactionsGet(
      this,
      request,
      options,
    ));
  ...
  async listLatest(
    ...
    >
  > {
    return unwrapResultIterator(dataPrimaryNetworkTransactionsListLatest(
      this,
      request,
      options,
    ));
   ...
   */
  async listActiveStakingTransactions(
  ...
  > {
    return unwrapResultIterator(
      dataPrimaryNetworkTransactionsListActiveStakingTransactions(
        this,
        request,
        options,
      ),
