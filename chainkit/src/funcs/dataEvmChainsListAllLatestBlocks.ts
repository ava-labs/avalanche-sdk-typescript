...
import { ListAllLatestBlocksServerList } from "../models/operations/listalllatestblocks.js";
 ...
 */
export function dataEvmChainsListAllLatestBlocks(
  ...
  PageIterator<
    Result<
      operations.ListAllLatestBlocksResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAllLatestBlocksRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListAllLatestBlocksServerList[0], {
      charEncoding: "percent",
    })();

  const path = pathToFunc("/v1/chains/allBlocks")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAllLatestBlocksResponse$inboundSchema, {
      key: "Result",
    }),
