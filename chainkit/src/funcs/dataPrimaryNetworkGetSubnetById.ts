...
import { GetSubnetByIdServerList } from "../models/operations/getsubnetbyid.js";
 ...
 */
export function dataPrimaryNetworkGetSubnetById(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetSubnetByIdServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/v1/networks/{network}/subnets/{subnetId}")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.Subnet$inboundSchema),
