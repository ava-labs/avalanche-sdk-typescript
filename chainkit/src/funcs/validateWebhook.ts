...
export async function validateWebhook(client: AvalancheCore, {
  request: rawRequest,
  secret,
}: {
  request: {
  ...
  Result<
    components.WebhookAddressActivityResponse,
...
> {
  ...
  const knownSchemas = [components.webhookAddressActivityResponseFromJSON];
