...
import { GetTotalL1ValidatorMetricsServerList } from "../models/operations/gettotall1validatormetrics.js";
 ...
 */
export function metricsL1ValidatorsListMetrics(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetTotalL1ValidatorMetricsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetTotalL1ValidatorMetricsServerList[0], {
  ...
  const path = pathToFunc("/v2/validators/metrics/{metric}")(pathParams);
