...
import { ListAllLatestTransactionsServerList } from "../models/operations/listalllatesttransactions.js";
 ...
 */
export function dataEvmChainsListAllLatestTransactions(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListAllLatestTransactionsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListAllLatestTransactionsServerList[0], {
      charEncoding: "percent",
    })();

  const path = pathToFunc("/v1/chains/allTransactions")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAllLatestTransactionsResponse$inboundSchema, {
      key: "Result",
    }),
