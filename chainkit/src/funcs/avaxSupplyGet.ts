...
import { GetAvaxSupplyServerList } from "../models/operations/getavaxsupply.js";
 ...
 */
export function avaxSupplyGet(
  client: AvalancheCore,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.AvaxSupplyResponse,
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(GetAvaxSupplyServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/v1/avax/supply")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.AvaxSupplyResponse$inboundSchema),
