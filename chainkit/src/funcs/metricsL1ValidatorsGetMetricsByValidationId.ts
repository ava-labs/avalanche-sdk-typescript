...
import { GetMetricsByValidationIdServerList } from "../models/operations/getmetricsbyvalidationid.js";
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetMetricsByValidationIdRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetMetricsByValidationIdServerList[0], {
      charEncoding: "percent",
    })();

  const pathParams = {
    l1ValidationId: encodeSimple("l1ValidationId", payload.l1ValidationId, {
      explode: false,
      charEncoding: "percent",
    }),
  ...
  const path = pathToFunc("/v2/validation/{l1ValidationId}/metrics/{metric}")(
    pathParams,
  );
