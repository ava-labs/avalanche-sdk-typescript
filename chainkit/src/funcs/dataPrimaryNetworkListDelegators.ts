...
import { ListDelegatorsServerList } from "../models/operations/listdelegators.js";
 ...
 */
export function dataPrimaryNetworkListDelegators(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListDelegatorsServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/v1/networks/{network}/delegators")(pathParams);

  const query = encodeFormQuery({
    "delegationStatus": payload.delegationStatus,
    "nodeIds": payload.nodeIds,
    "pageSize": payload.pageSize,
    "pageToken": payload.pageToken,
    "rewardAddresses": payload.rewardAddresses,
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListDelegatorsResponse$inboundSchema, {
      key: "Result",
    }),
