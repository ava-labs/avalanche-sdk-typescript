...
import { GetAggregatedSignaturesServerList } from "../models/operations/getaggregatedsignatures.js";
 ...
 */
export function dataSignatureAggregatorGet(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetAggregatedSignaturesRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAggregatedSignaturesServerList[0], {
