...
export function webhooksAddressesList(
  ...
  PageIterator<
    Result<
      operations.GetAddressesFromWebhookResponse,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAddressesFromWebhookServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetAddressesFromWebhookResponse$inboundSchema, {
      key: "Result",
    }),
