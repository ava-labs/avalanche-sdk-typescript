...
import { GetUtxosByAddressesServerList } from "../models/operations/getutxosbyaddresses.js";
 ...
 */
export function dataPrimaryNetworkUtxosListByAddresses(
  ...
  PageIterator<
    Result<
      operations.GetUtxosByAddressesResponse,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetUtxosByAddressesServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetUtxosByAddressesResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataPrimaryNetworkUtxosListByAddresses(
        client,
        {
          ...request,
