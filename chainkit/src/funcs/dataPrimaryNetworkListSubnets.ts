...
import { ListSubnetsServerList } from "../models/operations/listsubnets.js";
 ...
 */
export function dataPrimaryNetworkListSubnets(
  ...
  PageIterator<
    Result<
      operations.ListSubnetsResponse,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListSubnetsServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/v1/networks/{network}/subnets")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSubnetsResponse$inboundSchema, {
      key: "Result",
    }),
