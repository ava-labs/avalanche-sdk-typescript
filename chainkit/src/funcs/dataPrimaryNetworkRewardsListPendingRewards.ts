...
import { ListPendingPrimaryNetworkRewardsServerList } from "../models/operations/listpendingprimarynetworkrewards.js";
 ...
 */
export function dataPrimaryNetworkRewardsListPendingRewards(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListPendingPrimaryNetworkRewardsServerList[0], {
  ...
  const path = pathToFunc("/v1/networks/{network}/rewards:listPending")(
    pathParams,
  );
  ...
  >(
    M.json(
      200,
      operations.ListPendingPrimaryNetworkRewardsResponse$inboundSchema,
      { key: "Result" },
    ),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataPrimaryNetworkRewardsListPendingRewards(
        client,
        {
          ...request,
