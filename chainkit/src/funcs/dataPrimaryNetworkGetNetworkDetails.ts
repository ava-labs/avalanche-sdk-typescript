...
import { GetNetworkDetailsServerList } from "../models/operations/getnetworkdetails.js";
 ...
 */
export function dataPrimaryNetworkGetNetworkDetails(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetNetworkDetailsServerList[0], {
  ...
  const path = pathToFunc("/v1/networks/{network}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.GetNetworkDetailsResponse$inboundSchema),
