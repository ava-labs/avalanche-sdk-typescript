...
import { ListInternalTransactionsServerList } from "../models/operations/listinternaltransactions.js";
 ...
 */
export function dataEvmAddressTransactionsListInternal(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListInternalTransactionsServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListInternalTransactionsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataEvmAddressTransactionsListInternal(
        client,
        {
          ...request,
