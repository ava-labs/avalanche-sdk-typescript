...
import { ListTransactionsServerList } from "../models/operations/listtransactions.js";
 ...
 */
export function dataEvmAddressTransactionsList(
...
> {
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataEvmAddressTransactionsList(
        client,
        {
          ...request,
