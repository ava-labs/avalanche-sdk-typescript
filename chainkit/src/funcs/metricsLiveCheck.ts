...
import { MetricsLiveCheckServerList } from "../models/operations/metricslivecheck.js";
 ...
 */
export function metricsLiveCheck(
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(MetricsLiveCheckServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/v2/live-check")();
  ...
  const context = {
    ...
    baseURL: baseURL ?? "",
    operationID: "metrics-live-check",
    oAuth2Scopes: null,
