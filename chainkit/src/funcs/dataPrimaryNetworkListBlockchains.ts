 ...
 */
export function dataPrimaryNetworkListBlockchains(
  ...
  PageIterator<
    Result<
      operations.ListBlockchainsResponse,
...
> {
  ...
  const path = pathToFunc("/v1/networks/{network}/blockchains")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListBlockchainsResponse$inboundSchema, {
      key: "Result",
    }),
