...
import { LiveCheckServerList } from "../models/operations/livecheck.js";
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(LiveCheckServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/v1/live-check")();
