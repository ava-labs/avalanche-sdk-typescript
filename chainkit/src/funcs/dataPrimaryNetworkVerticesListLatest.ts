...
import { ListLatestXChainVerticesServerList } from "../models/operations/listlatestxchainvertices.js";
 ...
 */
export function dataPrimaryNetworkVerticesListLatest(
...
> {
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataPrimaryNetworkVerticesListLatest(
        client,
        {
          ...request,
