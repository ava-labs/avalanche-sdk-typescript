 ...
 */
export function dataPrimaryNetworkTransactionsGet(
  client: AvalancheCore,
  request: operations.GetTxByHashRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetTxByHashResponse,
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetTxByHashServerList[0], { charEncoding: "percent" })();
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetTxByHashResponse$inboundSchema),
