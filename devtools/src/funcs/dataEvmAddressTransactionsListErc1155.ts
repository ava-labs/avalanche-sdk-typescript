...
import { ListErc1155TransactionsServerList } from "../models/operations/listerc1155transactions.js";
 ...
 */
export function dataEvmAddressTransactionsListErc1155(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListErc1155TransactionsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListErc1155TransactionsServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListErc1155TransactionsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataEvmAddressTransactionsListErc1155(
        client,
        {
          ...request,
