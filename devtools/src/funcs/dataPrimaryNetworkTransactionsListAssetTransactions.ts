 ...
 */
export function dataPrimaryNetworkTransactionsListAssetTransactions(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListAssetTransactionsServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAssetTransactionsResponse$inboundSchema, {
      key: "Result",
    }),
