...
import { GenerateOrRotateSharedSecretServerList } from "../models/operations/generateorrotatesharedsecret.js";
 ...
 */
export function webhooksGenerateOrRotateSharedSecret(
...
> {
  const baseURL = options?.serverURL
    || pathToFunc(GenerateOrRotateSharedSecretServerList[0], {
