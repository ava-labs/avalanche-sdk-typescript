 ...
 */
export function dataEvmAddressTransactionsListErc721(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListErc721TransactionsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListErc721TransactionsServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListErc721TransactionsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataEvmAddressTransactionsListErc721(
        client,
        {
          ...request,
