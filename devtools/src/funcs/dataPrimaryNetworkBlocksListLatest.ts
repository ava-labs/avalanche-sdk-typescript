...
import { ListLatestPrimaryNetworkBlocksServerList } from "../models/operations/listlatestprimarynetworkblocks.js";
 ...
 */
export function dataPrimaryNetworkBlocksListLatest(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListLatestPrimaryNetworkBlocksServerList[0], {
  ...
  >(
    M.json(
      200,
      operations.ListLatestPrimaryNetworkBlocksResponse$inboundSchema,
      { key: "Result" },
    ),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataPrimaryNetworkBlocksListLatest(
        client,
        {
          ...request,
