...
import { GetIcmMessageServerList } from "../models/operations/geticmmessage.js";
...
export function dataIcmGet(
  ...
  Result<
    operations.GetIcmMessageResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetIcmMessageRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetIcmMessageServerList[0], { charEncoding: "percent" })();
  ...
  const path = pathToFunc("/v1/icm/messages/{messageId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetIcmMessageResponse$inboundSchema),
