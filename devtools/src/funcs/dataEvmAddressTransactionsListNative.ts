...
import { ListNativeTransactionsServerList } from "../models/operations/listnativetransactions.js";
 ...
 */
export function dataEvmAddressTransactionsListNative(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListNativeTransactionsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListNativeTransactionsServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.ListNativeTransactionsResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      dataEvmAddressTransactionsListNative(
        client,
        {
          ...request,
