 ...
 */
export function dataPrimaryNetworkBalancesListByAddresses(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetBalancesByAddressesServerList[0], {
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetBalancesByAddressesResponse$inboundSchema),
