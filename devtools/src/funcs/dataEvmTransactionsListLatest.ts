...
import { ListLatestTransactionsServerList } from "../models/operations/listlatesttransactions.js";
 ...
 */
export function dataEvmTransactionsListLatest(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListLatestTransactionsRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListLatestTransactionsServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListLatestTransactionsResponse$inboundSchema, {
      key: "Result",
    }),
