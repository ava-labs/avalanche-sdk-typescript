...
import { ListIcmMessagesServerList } from "../models/operations/listicmmessages.js";
...
export function dataIcmList(
  ...
  PageIterator<
    Result<
      operations.ListIcmMessagesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListIcmMessagesRequest$outboundSchema.parse(value),
  ...
  const baseURL = options?.serverURL
    || pathToFunc(ListIcmMessagesServerList[0], { charEncoding: "percent" })();

  const path = pathToFunc("/v1/icm/messages")();
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListIcmMessagesResponse$inboundSchema, {
      key: "Result",
    }),
