 ...
 */
export function metricsChainsListBTCbBridgersAboveThreshold(
...
> {
  ...
  const baseURL = options?.serverURL
    || pathToFunc(GetAddressesByBtcbBridgedServerList[0], {
  ...
  const [result, raw] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetAddressesByBtcbBridgedResponse$inboundSchema, {
      key: "Result",
    }),
  ...
  const nextFunc = (
    ...
    const nextVal = () =>
      metricsChainsListBTCbBridgersAboveThreshold(
        client,
        {
          ...request,
