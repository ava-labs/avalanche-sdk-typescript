 ...
 * Type of transaction.
 */
export const CChainExportTransactionTxType = {
  ExportTx: "ExportTx",
} as const;
/**
 * Type of transaction.
 */
export type CChainExportTransactionTxType = ClosedEnum<
...
export type CChainExportTransaction = {
   ...
   * Type of transaction.
   */
  txType: CChainExportTransactionTxType;
...
> = z.object({
  ...
  txType: CChainExportTransactionTxType$inboundSchema,
...
> = z.object({
  ...
  sourceChain: z.string(),
  destinationChain: z.string(),
  txType: CChainExportTransactionTxType$outboundSchema,
